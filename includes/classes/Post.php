...
class Post{
	...
	public function loadPostsFriends($data, $limit) {
		...
		if(mysqli_num_rows($data_query) > 0) {
			...
			while($row = mysqli_fetch_array($data_query)) {
				...
				//Prepare user_to string to be included even when not posted to a user
				if($row['user_to'] == "none") {
					$user_to = "";
				}
				else{
				...
				//Check account status (opened/closed) of user that posted
				...
				if($user_logged_obj->isFriend($added_by)){
	                ...
	                if($userLoggedIn == $added_by)
	                	$delete_button = "<button class='delete_button' id='post$id'><img src='assets/images/icons/delete.png' width= '20'></button>";
	                else
	                	$delete_button = "";
					...
					$str .="<div class='status_post' onClick='javascript:toggle$id()'>
					           ...
					           <div class='posted_by' style='color:#ACACAC;'>
					            ...
					            <div class='newsfeedPostOptions'>
					             <img src='assets/images/icons/comments.png' width='20'> $comments_check_num&nbsp;&nbsp;&nbsp;
			    ...
			    <script>
			       ...
			       $(document).ready(function() {
			       	  ...
			       	  $('#post<?php echo $id; ?>').on('click', function() {
			       	  	bootbox.confirm("Are you sure you ant to delete this post?", function(result) {
	...
	public function getSinglePost($post_id) {       
		...
		if(mysqli_num_rows($data_query) > 0) {
	    	...
	    	echo "<p>No post found. Clicking a link may cause a break.</p>";
			    	return;
	    } 
